...
//  ExtendedFoundation
//
//  Created by Jérémy Brault on 09/03/2020.
...
@propertyWrapper
public class Field<Value: Equatable>: Validable {
    ...
    var dynamicValidationErrorBlocks = [Mapper<Value, Error?>]()
    ...
    public func validationError() -> Error? {
        ...
        if let wrappedValue = wrappedValue, valueIsNotAnEmptyString {
